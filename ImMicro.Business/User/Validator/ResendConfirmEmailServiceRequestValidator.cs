...
{
    public class ResendConfirmEmailServiceRequestValidator : AbstractValidator<ResendConfirmEmailServiceRequest>
    {
        public ResendConfirmEmailServiceRequestValidator()
        {
